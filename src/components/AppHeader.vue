...
import { ChevronDown, ClipboardCheck, Clock3, LogIn, LogOut, UserRound } from 'lucide-vue-next'
...
<template>
  <header class="topbar">
    ...
    <div class="topbar-actions">
      <button class="button button-ghost top-link" type="button" @click="$emit('top')">Топ</button>
      <ThemeToggle />
